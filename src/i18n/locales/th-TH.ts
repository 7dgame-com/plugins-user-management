export default {
  ...
  user: {
    ...
    loginAudit: {
      action: 'บันทึกเข้าสู่ระบบ',
      title: 'บันทึกเข้าสู่ระบบ',
      loginCount: 'เข้าสู่ระบบสำเร็จ',
      failedLoginCount: 'เข้าสู่ระบบล้มเหลว',
      lastLoginAt: 'เข้าสู่ระบบสำเร็จล่าสุด',
      lastFailedLoginAt: 'เข้าสู่ระบบล้มเหลวล่าสุด',
      occurredAt: 'เวลา',
      eventType: 'เหตุการณ์',
      result: 'ผลลัพธ์',
      source: 'แหล่งที่มา',
      ...
      success: 'สำเร็จ',
      failed: 'ล้มเหลว',
      noRecords: 'ไม่มีบันทึกเข้าสู่ระบบ',
      messages: {
        fetchFailed: 'ไม่สามารถดึงบันทึกเข้าสู่ระบบ',
      },
    },
    messages: {
